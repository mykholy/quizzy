                ...
                <div class="main-header-left ">
                    <div class="responsive-logo">
                        <a href="index.html" class="header-logo">
                            <img src="{{asset(setting('logo'))}}" class="logo-1" alt="logo">
                            <img src="{{asset(setting('logo'))}}" class="dark-logo-1" alt="logo">
                        </a>
                    </div>
...
{{--                                </li>--}}
                                ...
                                <li  class="dropdown main-profile-menu nav nav-item nav-link">
                                    <a class="profile-user d-flex" href=""><img alt="" src="{{ Auth::user()->photo }}"></a>
                                    <div class="dropdown-menu">
                                        <div class="main-header-profile bg-primary p-3">
                                            <div class="d-flex wd-100p">
                                                <div class="main-img-user"><img alt="" src="{{ Auth::user()->photo }}" class=""></div>
...
{{--                                        <a class="dropdown-item" href="chat.html"><i class="bx bx-envelope"></i>Messages</a>--}}
    ...
    <div class="main-footer">
        <div class="container-fluid pd-t-0 ht-100p">
            <span> Copyright © {{date('Y')}} <a href="javascript:void(0);" class="text-primary">{{setting('application_name')}}</a>. Designed with <span class="fa fa-heart text-danger"></span> by <a href="https://web.facebook.com/A2rSoft/"> A2rSoft </a> All rights reserved.</span>
        </div>
    </div>
    <!-- Footer closed -->
