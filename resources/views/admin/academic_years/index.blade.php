...
@section('breadcrumb')
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
                        ...
                        <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0);">{{ __('models/academicYears.singular')}}</a></li>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{{ __('models/academicYears.plural')}}</h3>

                <div class="col-sm-6">
                    <a class="btn btn-primary float-right"
                       href="{{ route('admin.academicYears.create') }}">
                        {!! __('lang.add_new') !!}
                    </a>
            ...
            <div class="card-body">
                @include('admin.academic_years.table')
            </div>
        </div>
    </div>
@endsection
