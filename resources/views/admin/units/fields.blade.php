...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('subject_id',\App\Models\Admin\Subject::pluck('name','id')->toArray(),request('subject_id'), array('class' => 'form-control select2 select2-hidden-accessible'. ($errors->has('subject_id')?' is-invalid ':''),'required'=>'required', 'ui-jp'=>"select2",'ui-options'=>"{theme: 'bootstrap'}" )) !!}
