<div class='btn-group'>
    ...
    @endif
    <a type="button" href="{{ route('admin.questions.show', $question->id) }}" class="btn btn-info mx-2 button-icon mb-1 btn-sm"><i
            class="fe fe-eye me-2"></i> {{__('lang.show')}}</a>
    <a type="button" href="{{ route('admin.questions.edit', $question->id) }}"
