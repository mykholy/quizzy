<div class='btn-group'>
    <a type="button" href="{{ route('admin.questions.show', $id) }}" class="btn btn-info mx-2 button-icon mb-1 btn-sm"><i
            class="fe fe-eye me-2"></i> {{__('lang.show')}}</a>
    <a type="button" href="{{ route('admin.questions.edit', $id) }}"
    ...
    <form id="Row{{$id}}"
          action="{{ route('admin.questions.destroy', $id) }}"
