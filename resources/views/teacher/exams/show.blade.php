...
@section('breadcrumb')
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
                        ...
                        <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0);">{{ __('models/exams.singular')}}</a></li>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{{ __('models/exams.plural')}} {{ __('lang.detail')}}</h3>
                <div class="col-sm-6">
            ...
            <div class="card-body">
                <div class="row">
                    @include('teacher.exams.show_fields')
                </div>
            </div>
        </div>
    </div>
