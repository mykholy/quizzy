<div class='btn-group'>
    <a type="button" href="{{ route('teacher.groups.show', $id) }}" class="btn btn-info mx-2 button-icon mb-1 btn-sm"><i
            class="fe fe-eye me-2"></i> {{__('lang.show')}}</a>
{{--    <a type="button" href="{{ route('teacher.groups.edit', $id) }}"--}}
...
{{--    </a>--}}
{{--    <form id="Row{{$id}}"--}}
{{--          action="{{ route('teacher.groups.destroy', $id) }}"--}}
