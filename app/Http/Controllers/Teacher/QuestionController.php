...
use App\DataTables\Teacher\QuestionDataTable;
...
class QuestionController extends AppBaseController
{
    ...
    {
        return $questionDataTable->render('teacher.questions.index', ['lesson_id' => request('lesson_id')]);
    }
    ...
    public function create()
    {
        if (\request('bulkImport')) {
            return view('teacher.questions.bulkImport');
        }
    ...
    public function store(CreateQuestionRequest $request)
    {
        ...
        return redirect(route('teacher.questions.index', ['lesson_id' => request('lesson_id')]));
    }
...
//                    $files_url_data[] = asset($file);
                ...
                return view('teacher.questions.bulkImport', compact('files_url_data'));
    ...
    public function show($id)
    {
        ...
        return view('teacher.questions.show')->with('question', $question);
    }
    ...
    public function edit($id)
    {
        ...
        return view('teacher.questions.edit')->with('question', $question);
    }
