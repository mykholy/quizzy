...
use App\DataTables\Teacher\AnswerDataTable;
...
class AnswerController extends AppBaseController
{
    ...
    public function index(AnswerDataTable $answerDataTable)
    {
        ...
        return $answerDataTable->with('question_id', $question_id)->render('teacher.answers.index',['question_id' => $question_id],compact('question'));

//        return $answerDataTable->render('teacher.answers.index', ['question_id' => $question_id], compact('question'));
    }
    ...
    public function create()
    {
        $question_id = \request('question_id');
        $question = Question::find($question_id);
        return view('teacher.answers.create', compact('question'));
    }
    ...
    public function store(CreateAnswerRequest $request)
    {
        try {
            ...
            return redirect(route('teacher.answers.index', ['question_id' => request('question_id')]));
    ...
    public function show($id)
    {
        ...
        return view('teacher.answers.show')->with('answer', $answer);
    }
    ...
    public function edit($id)
    {
        ...
        return view('teacher.answers.edit', compact('question'))->with('answer', $answer);
    }
