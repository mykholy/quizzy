...
class CarDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable->editColumn('photo', function (Car $model) {

            $photo = $model->photo ;
            return view('includes.lazy_photo', compact('photo'));
        });

        $dataTable->editColumn('is_active', function (Car $model) {
...
//                    ['extend' => 'reload', 'className' => 'btn btn-default btn-sm no-corner',],
    ...
    {
        return [
            'name' => new Column(['title' => __('models/cars.fields.name'), 'data' => 'name']),
            'photo' => new Column(['title' => __('models/cars.fields.photo'), 'data' => 'photo']),
            'is_active' => new Column(['title' => __('models/cars.fields.is_active'), 'data' => 'is_active'])
        ];
    }
