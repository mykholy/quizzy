(function ($) {
    ...
    $.fn.inputTags.defaults = {
        ...
        errors: {
            empty: 'Be careful, you cannot add an empty tag.',
            minLength: 'Be careful, your tag must have at least %s characters.',
            maxLength: 'Be careful, your tag must not exceed %s characters.',
            max: 'Please note, the number of tags must not exceed %s.',
            email: 'Please note, the email address you entered is not valid.',
            exists: 'Attention, this tag already exists!',
            autocomplete_only: 'Be careful, you must select a value from the list.',
            timeout: 8000
        }
    };
